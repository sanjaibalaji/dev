...
let menuGaps = [];
let smallmenuGaps = []
const PageHeader: React.FC<pageheaderproperties> = ({screenwidth,screenheight,assetpath})  => {
            ...
            <div className = {css.smallMenuButtons}>
                 ...
                 { smallmenuoptionsstring.indexOf("Partner With LHome,") < 0?
                  ...
                  { smallmenuoptionsstring.indexOf("Refer and Earn,") < 0?
                    <div className={`${css.smallMenuBand} ${css.customWidthpx_12}`}>
                        Refer and Earn
                    </div>   
                  : ''}          
            ...
            <div className={css.largeMenuButtons} id = "largeoptions">
                 ...
                 <div className={css.menuHolder}>
                   ...
                   { menuoptionsstring.indexOf("Wardrobe,") < 0?                      
                      <div id = "wardrobe" rel = "largeoptions" className={`${css.largeMenuBand} ${css.customWidthpx_10}`}>
                            Wardrobe
                      </div>
                     : ''
                   }
                   { menuoptionsstring.indexOf("Bedroom,") < 0?                    
                      <div id = "bedroom" rel = "largeoptions" className={`${css.largeMenuBand} ${css.customWidthpx_10}`}>
                           Bedroom
                      </div>
                     : ''
                   }
                   { menuoptionsstring.indexOf("Living Room,") < 0?                       
                       <div id = "livingroom" rel = "largeoptions" className={`${css.largeMenuBand} ${css.customWidthpx_12}`}>
                            Living Room
                       </div>
                     : ''
                   }    
                   { menuoptionsstring.indexOf("Bath Room,") < 0?                     
                      <div id = "bathroom" rel = "largeoptions" className={`${css.largeMenuBand} ${css.customWidthpx_10}`}>
                            Bath Room
                      </div>
                     : ''
                   }
                   { menuoptionsstring.indexOf("Space Saving Furniture,") < 0?                   
                      <div id = "spacesavingfurniture" rel = "largeoptions" className={`${css.largeMenuBand} ${css.customWidthpx_20}`}>
                            Space Saving Furniture
                      </div>
                     : ''
                   }
                   { menuoptionsstring.indexOf("Home Office,") < 0?                       
                       <div id = "homeoffice" rel = "largeoptions" className={`${css.largeMenuBand} ${css.customWidthpx_12}`}>
                           Home Office
                       </div>
                     : ''  
                   }   
                   { menuoptionsstring.indexOf("Others,") < 0?                    
                      <div id = "others" rel = "largeoptions" className={`${css.largeMenuBand} ${css.customWidthpx_6}`}>
                            Others
                      </div>  
                      : ''
                   }     
